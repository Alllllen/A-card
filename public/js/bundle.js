...
if (creatPostForm) creatPostForm.addEventListener('submit', function (e) {
  ...
  var select = document.getElementById('board').value; // const boarId = select.options[select.selectedIndex].value;
