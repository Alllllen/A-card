...
exports.regist = exports.logout = exports.login = void 0;
...
var regist = /*#__PURE__*/function () {
  ...
  return function regist(_x3, _x4, _x5, _x6) {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"posts.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateLike = exports.deletePost = exports.createComment = exports.create = void 0;
...
var create = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(title, content, board, tag) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Post a post successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1".concat(window.location.pathname, "/comments/"),
              data: {
                content: content
              }
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'post a comment successfully!');
              window.setTimeout(function () {
...
var deletePost = /*#__PURE__*/function () {
  ...
  return function deletePost(_x6) {
    return _ref4.apply(this, arguments);
  };
}();

exports.deletePost = deletePost;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"cards.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.disacceptFriend = exports.acceptFriend = void 0;
...
var disacceptFriend = /*#__PURE__*/function () {
  ...
  return function disacceptFriend() {
    return _ref2.apply(this, arguments);
  };
}();

exports.disacceptFriend = disacceptFriend;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"message.js":[function(require,module,exports) {
"use strict";
...
function message() {
  $(function () {
    ...
    var socket = io(); // Prompt for setting a username

    var username = 'jacky';
    var connected = true;
    var typing = false;
    var lastTypingTime;
    var $currentInput = $usernameInput.focus(); // const addParticipantsMessage = (data) => {
    //   let message = '';
    //   if (data.numUsers === 1) {
    ...
    var addChatMessage = function addChatMessage(data) {
      ...
      .addClass(typingClass).append($messageBodyDiv);
    ...
    socket.on('user joined', function (data) {
      log("".concat(data.username, " joined")); //   addParticipantsMessage(data);
    }); // Whenever the server emits 'user left', log it in the chat body

    socket.on('user left', function (data) {
      log("".concat(data.username, " left")); //   addParticipantsMessage(data);
    ...
    socket.on('room-brocast', function (message) {
      log(message);
    });
  });
}
...
// DOM ELEMENTS
var registForm = document.querySelector('.form--regist');
var loginForm = document.querySelector('.form--login');
var logOutBtn = document.querySelector('.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password'); //寫文章、留言

var creatPostForm = document.querySelector('.form--creatPost');
var creatCommentForm = document.querySelector('.form--comment'); // 案文章讚

var updateLikeForm = document.querySelector('.form--like'); //抽卡

var agreeFriendForm = document.querySelector('.agreeFriend');
var disagreeFriendForm = document.querySelector('.disagreeFriend'); //刪除貼文
...
if (registForm) registForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var name = document.getElementById('name').value;
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
  var passwordComfirm = document.getElementById('passwordComfirm').value;
  (0, _login.regist)(name, email, password, passwordComfirm);
});
...
if (creatPostForm) creatPostForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var title = document.getElementById('title').value;
  var content = document.getElementById('content').value;
  var select = document.getElementById('board').value;
  var tag = '6241a903ee80052724ffd88b'; // const tag = document.getElementById('tag').value;

  (0, _posts.create)(title, content, select, tag);
});
if (creatCommentForm) creatCommentForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var content = document.getElementById('comment').value;
  (0, _posts.createComment)(content);
});
if (updateLikeForm) updateLikeForm.addEventListener('submit', function (e) {
  e.preventDefault();
  (0, _posts.updateLike)();
});
...
if (agreeFriendForm) agreeFriendForm.addEventListener('submit', function (e) {
  e.preventDefault();
  (0, _cards.acceptFriend)();
});
if (disagreeFriendForm) disagreeFriendForm.addEventListener('submit', function (e) {
  e.preventDefault();
  (0, _cards.disacceptFriend)();
}); //上傳照片POST
